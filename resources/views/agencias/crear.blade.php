...
@section('contenido')
	<h2 class="my-3">Agregar nueva agencia aduanal</h2>
	<form method="POST" action="{{ route('agencias.store') }}" class="form-inline mt-4 pl-4" enctype="multipart/form-data">
		...
		<div class="card w-100">
			...
			<div class="card-block w-100 form-inline input-group">
				...
				<select name="agente_id" id="agente_id" class="form-control w-25 mb-2">
				...
				<input type="file" name="logotipo" id="logotipo" class="form-control w-25 mb-2">
			</div>
		</div>
		<div class="card w-100">
			<div class="card-header w-100">
